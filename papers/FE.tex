...
To keep the variance small and so to ensure a bell-shaped mass function, $s=e_1[\mu(N-\mu)-\frac{\mu}{N}(N-\mu)] + \frac{\mu}{N}(N-\mu) = \frac{\mu}{N}(Ne_1-e_1+1)$, for $e_1 \in (0,1)$ and smalls.
