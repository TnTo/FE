...
% The 2-lagged variables create problems in the start-up of the model. A solution is the strong approximation $\mu_t \approx \mu_{t-1}(1+\Theta(\rho_\mathbf{K}\frac{s_{t-1}}{\mathbf{k}^*_{t-1}}-1))$.
...
\begin{xltabular}{\linewidth}{lXlX}
    ...
    $r_\Pi$                      & Profit distribution rate                                     &  & Calibration; $1> \cdot >0$; Bank's capital ratio                                                                                                                                                            \\
...
\begin{xltabular}{\linewidth}{Xllll}
    ...
    \toprule \endhead
    \bottomrule \endfoot
    Intergenerational mobility & $\mathbb{P}(\sigma_0 \ge 5 | \sigma_0^{parent} \ge 5)$ & $[0.67:0.65]$ & $\ge 0.7$ & \endnote{Holders of bachelor degree, childrens of holders of bachelor degree, ITALY 2022 \url{https://www.istat.it/it/files//2023/10/Report-livelli-di-istruzione-e-ritorni-occupazionali.pdf}} \\
    ...
    Growth rate skweness & $\gamma(g^y)$ & $-0.19$ & $<0$ & \endnote{ITALY 2012-2022 \url{https://ec.europa.eu/eurostat/databrowser/view/tec00001/default/table?lang=en}}\\
    ...
    Housedhold exempted from tax payment & $|\{h|t^h = 0\}|/N^\mathcal{H}$ & $0.24$ & $[0.15:0.25]$ & \endnote{ITALY 2021 \url{https://www1.finanze.gov.it/finanze/analisi_stat/public/v_4_0_0/contenuti/analisi_dati_2021_irpef.pdf} (§1.8)}\\
    Unemployment rate & $\omega^y$ & $[0.081:0.124]$ & $[0.00:0.10]$ & \endnote{ITALY 2011-2022 \url{http://dati.istat.it/Index.aspx?DataSetCode=DCCV_TAXDISOCCU1}}\\
    ...
    Kurtosis of firms' size & $\kappa(\#employed_f)$ & & $\ge 6$ & \endnote{Kurtosis of exponential distribution} \\
