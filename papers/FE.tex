...
\makebox[\textwidth][c]{
    ...
    \begin{tabularx}{\textwidth}{@{} Y|ccccc|l @{}}
        ...
        Investment             &                                          & $-p_{\mathbf{K}} \mathbf{K}_{\mathcal{F}_{\mathbf{C}}}$    & $+p_{\mathbf{K}} (\mathbf{K} - \mathbf{K}_{\mathcal{F}_{\mathbf{C}}})$ &                              &                                          & 0                                 \\
...
This 2-lagged variables are the only one in the model. To simplify the implementation the strong approximation $\mu_t \approx \mu_{t-1}(1+\Theta(\rho_\mathbf{K}\frac{s_{t-1}}{\mathbf{k}^*_{t-1}}-1))$ is adopted.
