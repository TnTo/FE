...
\begin{tabularx}{\linewidth}{lXll}
	...
	$N_{\mathcal{F}_\mathbf{C}}$ & Number of Comsumption Firms                                  &        &        \\
...
It is easy to see that the number of trials is the maximum possible result of a drawn, and so $N=\sigma^M$.
